...
class MyBooks extends React.Component{
    ...
    updateBookList = (book) => {
        this.state.bookList = setState([...this.state.bookList, book]);
    }
    render(){
        return <div className={styles.myBooks}>
            ...
            {this.state.showPopUp ?
                <BookPopUp showPopUp={this.state.showPopUp} bookList={this.state.bookList} updateBookList={updateBookList}/>
                : null}
        </div>
    }
}
